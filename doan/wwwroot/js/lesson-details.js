document.addEventListener('DOMContentLoaded', async function () {
    ...
    // Cập nhật UI trạng thái học/chưa học cho từng hàng trong bảng
    ...
    // Khởi tạo trạng thái cho tất cả các hàng dựa trên learnedIds
    ...
    // Bắt sự kiện click cho toggle trạng thái học/chưa học
    ...
    $('#comment-form').on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/Lesson/DangBai', // nếu post về MVC cùng origin thì giữ nguyên
            contentType: 'application/json',
            headers: { 'RequestVerificationToken': token },
            data: JSON.stringify({ BaiHocId: baiHocId, TieuDe: "Bình luận bài học", NoiDung: noiDung, UserId: userId }),
            xhrFields: { withCredentials: true }, // gửi cookie
            success: function (response) { /* ... giữ nguyên ... */ },
            error: function (xhr) {
                if (xhr.status === 401) {
